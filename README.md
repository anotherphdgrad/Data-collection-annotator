...
start and end of the session, enter each stress/craving response, and export a
timestamped CSV file for the participant.
...
6. Click **Add Entry**.
   - You can also press `Enter` after filling both boxes.
7. Repeat this for each prompt in the video.
...
```text
participant_id,experiment_start,experiment_end,entry_number,elapsed_seconds,wall_clock_timestamp,stress,craving
```

Example row:

```csv
TEST001,2026-05-12T05:44:02,2026-05-12T05:52:10,1,42.318,2026-05-12T05:44:44,2,1
```
